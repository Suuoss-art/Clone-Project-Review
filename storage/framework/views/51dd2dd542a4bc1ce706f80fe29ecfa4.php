...
<head>
    ...
    <style>
        ...
        .right-panel {
            flex: 1;
            background: url('<?php echo e(asset('images/welcome-page.jpg')); ?>') no-repeat center center;
...
<body>
    <div class="split-screen">
        <div class="left-panel">
            <div class="content">
                <img src="<?php echo e(asset('images/desnet-logo.png')); ?>" alt="Logo Desnet" class="logo">
...
<?php /**PATH /home/runner/work/Clone-Project-Review/Clone-Project-Review/resources/views/welcome.blade.php ENDPATH**/ ?>